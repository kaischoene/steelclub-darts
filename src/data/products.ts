...
export const products: Product[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 89,
    description: "Atmungsaktives Performance-Polo im Steel Club Darts Design. Getragen von den Profis.",
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 156,
    description: "Premium Hoodie mit Steel Club Darts Print. Perfekt für die Sport-Bar und den Trainingsalltag.",
  ...
  },
  {
    ...
    name: "Steel Club Cap",
    price: 24.95,
    image: img("steel-club-cap"),
    images: [img("steel-club-cap")],
    category: "merchandise",
    maxHoppRecommended: false,
    rating: 4.4,
    reviewCount: 78,
    description: "Klassisches Snapback Cap mit gesticktem Steel Club Logo.",
  ...
  {
    id: 8,
    slug: "steel-club-keyring",
    name: "Steel Club Schlüsselanhänger",
    price: 9.95,
    image: img("steel-club-keyring"),
    images: [img("steel-club-keyring")],
    category: "merchandise",
    maxHoppRecommended: false,
    rating: 4.2,
    reviewCount: 45,
    description: "Metall-Schlüsselanhänger mit Steel Club Logo.",
