...
export const events: DartEvent[] = [
  ...
  {
    id: 2,
    slug: "steel-club-open-2026",
    title: "Steel Club Open 2026",
    date: "2026-05-25",
    ...
    lat: 52.52,
    lng: 13.405,
    image: img("steel-club-open-2026"),
    heroImage: img("steel-club-open-2026"),
    league: "Profi",
    pinColor: "orange",
    participants: ["maximilian-mueller", "lisa-koenig", "david-bauer", "sarah-weber", "tom-schneider", "max-hopp"],
    prizeMoney: 50000,
    description: "Das Flaggschiff-Event der Steel Club Darts Liga in Berlin. Hochkarätige Spieler aus ganz Deutschland kämpfen um den Open-Titel.",
