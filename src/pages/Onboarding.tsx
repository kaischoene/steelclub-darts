    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center mt-6">
          <div className="w-24 h-24 rounded-3xl bg-orange/10 flex items-center justify-center mb-6">
    ...
    <OnboardingShell step={3} onBack={() => setStep(2)} hideContinue>
      <div className="flex flex-col items-center mt-8">
        ...
        <div className="w-full max-w-sm mt-8 space-y-3">
          <button className="w-full bg-ink text-white font-bold py-4 rounded-pill flex items-center justify-center gap-3 transition active:scale-95 hover:bg-ink-soft">
            <Apple size={20} fill="white" />
            Mit Apple anmelden
          </button>
          <button className="w-full bg-white border border-black/[0.12] text-ink font-bold py-4 rounded-pill flex items-center justify-center gap-3 transition active:scale-95 hover:bg-surface-gray">
