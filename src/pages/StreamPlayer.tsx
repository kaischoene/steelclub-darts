    ...
    <AppShell>
      ...
      <div className="relative bg-ink aspect-video">
        ...
        <div className="absolute top-0 left-0 right-0 flex items-center justify-between p-4 pt-6">
          <button
            ...
            className="w-10 h-10 rounded-full bg-white/20 backdrop-blur flex items-center justify-center shadow-soft active:scale-95"
          >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <button className="w-24 h-24 rounded-full bg-white/20 backdrop-blur-xl border-2 border-white/40 flex items-center justify-center hover:scale-110 transition-all shadow-2xl active:scale-95">
      ...
      {stream.player1 && stream.player2 && (
        <section className="px-4">
          <div className="bg-ink rounded-3xl p-5 text-white relative overflow-hidden shadow-elevated">
            <div className="absolute -right-12 -bottom-12 w-40 h-40 rounded-full bg-orange/20 blur-3xl" />
      ...
      <section className="mt-6 px-4">
        ...
        <div className="bg-white border border-black/[0.06] rounded-3xl shadow-soft overflow-hidden">
          ...
          <div className="border-t border-black/[0.06] p-3 flex items-center gap-2">
            <input
