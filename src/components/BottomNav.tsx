...
export function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[1000] bg-bg-surface/95 backdrop-blur-xl border-t border-white/10 shadow-nav pb-[env(safe-area-inset-bottom,0px)]">
